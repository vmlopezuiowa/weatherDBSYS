...
namespace WeatherApp.Controllers
{
    public class WeatherRiseController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ZIP,City,State,Day,Temperature,FeelsLike,WindDirection,WindSpeed,Humidity,AirPressure,Visibility,UVIndex,Sunrise,Sunset,Moonrise,Moonset,Temperature_Celsius")] WeatherRise WeatherRise)
        {
